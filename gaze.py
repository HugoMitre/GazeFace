...
def gaze(frame, points):
    ...
    if transformation is not None:  # Si estimateAffine3D fue exitoso
        ...
        cv2.line(frame, p1_left_eye, p2_left_eye, (255, 165, 0), 2)
        ...
        cv2.line(frame, p1_right_eye, p2_right_eye, (255, 165, 30), 2)
        ...
        cv2.putText(frame, RER, (50, 100), font, 1, (255, 165, 30), 2, cv2.LINE_4)
        cv2.putText(frame, REL, (50, 150), font, 1, (255, 165, 30), 2, cv2.LINE_4) 
